...
<table width="100%">
  <tr>
    <td width="33%" valign="top"><img src="./assets/profile-class-zh.svg" alt="类别：程序员" width="100%"></td>
    <td width="33%" valign="top"><img src="./assets/profile-status-zh.svg" alt="状态：构建、测试、重复" width="100%"></td>
    <td width="33%" valign="top"><img src="./assets/profile-alignment-zh.svg" alt="倾向：好奇中立" width="100%"></td>
  </tr>
  <tr>
    <td width="33%" valign="top"><img src="./assets/profile-quest-zh.svg" alt="任务：交付一个可运行成果" width="100%"></td>
    <td width="33%" valign="top"><img src="./assets/profile-inventory-zh.svg" alt="工具箱：代码、文档与工具" width="100%"></td>
    <td width="33%" valign="top"><img src="./assets/profile-coordinate-zh.svg" alt="坐标：UMBRA 51430150" width="100%"></td>
  </tr>
...
<img src="./assets/umbra-moon-zh.svg" alt="huangyue12120 的横版 UMBRA 月影标记" width="760">
...
<img src="./assets/umbra-cycle-zh.svg" alt="UMBRA 的 30、15、0 动态横版阶段循环" width="760">
